<?php $__env->startSection('title', 'Mapeador de Cómic: ' . $resource->title); ?>
...
<div class="max-w-7xl mx-auto space-y-6">
    <div class="flex flex-wrap justify-between items-center bg-slate-800 p-6 rounded-xl border border-slate-700 shadow-xl gap-4">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('resources.show', $resource)); ?>" target="_blank" class="bg-teal-600 hover:bg-teal-500 text-white font-bold py-2 px-4 rounded-lg transition shadow-lg" title="Ver resultado en una nueva pestaña">
                👀 Ver Resultado
            </a>
            <a href="<?php echo e(route('resources.edit', $resource)); ?>" class="bg-slate-700 hover:bg-slate-600 text-white font-bold py-2 px-4 rounded-lg transition">Volver</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const url = "<?php echo e(route('comic.stream', $resource->id)); ?>";
        ...
        let allPanels = <?php echo json_encode($resource->comic_metadata ?? new stdClass()); ?>;
        ...
        document.getElementById('btn-save').addEventListener('click', () => {
            ...
            fetch("<?php echo e(route('comic.metadata.update', $resource->id)); ?>", {
                method: 'PUT',
                headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ricardo/workspace/ocanyaweb/corrol/resources/views/comic/mapper.blade.php ENDPATH**/ ?>